...
class GIDEncoderDecoder(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(GIDEncoderDecoder, self).__init__(init_cfg)
    ...
    def simple_test(self, img, img_meta, rescale=True):
        ...
        # Here, we visualized the seg_pred
        if int(img_meta[0]['ori_filename'][:-4]) % 40 == 0:
            file_name = img_meta[0]['ori_filename'][:-4] + ".jpg"
            save_path = "/home/wangyuhao/vis/UPerNet_convnext_rgb"
